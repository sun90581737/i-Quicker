    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sult4 > 0)
                {
                    int ret4 = ds4.DeleteSql(string.Format("UPDATE nfinebase.Sys_PMHomeOutsourcingRate SET IsEffective=0 where id<{0}", re4));
                ...
                if (sult5 > 0)
                {
                    int ret5 = ds5.DeleteSql(string.Format("UPDATE nfinebase.Sys_PMHomeOutsourcingDetail SET IsEffective=0 where id<{0}",re5));
